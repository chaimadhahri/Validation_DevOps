...
import tn.esprit.spring.dtos.SkierDTO;
...
public class SkierRestController {
    ...
    public Skier addSkier(@RequestBody SkierDTO skierDTO){
        Skier skier =  new Skier(skierDTO.getNumSkier(),skierDTO.getFirstName(),skierDTO.getLastName(),skierDTO.getDateOfBirth(), skierDTO.getCity(), null,null,null);
